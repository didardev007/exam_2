<form action="{{ url()->current() }}">
    <div class="mb-3">
        <label for="categories" class="form-label fw-semibold text-danger"></label>
    ...
    <div class="mb-3">
        ...
        <select class="form-select form-select-sm" name="sort" id="sort">
            <option value="new-to-old" {{ 'new-to-old' == $f_sort ? 'selected' : '' }}></option>
            <option value="old-to-new" {{ 'old-to-new' == $f_sort ? 'selected' : '' }}></option>
            <option value="low-to-high" {{ 'low-to-high' == $f_sort ? 'selected' : '' }}></option>
            <option value="high-to-low" {{ 'high-to-low' == $f_sort ? 'selected' : '' }}></option>
        </select>
    </div>
    <div class="mb-3">
